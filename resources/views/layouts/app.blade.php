...
<head>
    ...
    <title>{{ config('app.name', 'Toury') }}</title>
    ...
    <link href="{{ asset('css/appOverride.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand pull-left" href="{{ url('/') }}">{{ config('app.name', 'Toury') }}</a>
        ...
        <main class="py-4">
            <div class="mainContainer" style="max-width: 800px; margin-left:auto; margin-right:auto;">
                @yield('content')
            </div>
        </main>
    </div>
